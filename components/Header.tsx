        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Link href="/" className="flex items-center space-x-2">
              ...
              <div>
                <h1 className="text-xl font-bold text-black">Nogura Ramen Bar</h1>
                <p className="text-xs text-gray-600">Authentic Japanese Ramen</p>
              </div>
            </Link>

            {/* Desktop Navigation */}
            <nav className="hidden md:flex space-x-8">
              <Link href="/" className="flex items-center space-x-1 text-black hover:text-gray-600 transition-colors">
                <Home className="w-4 h-4" />
                <span>Beranda</span>
              </Link>
              <Link href="#menu" className="flex items-center space-x-1 text-black hover:text-gray-600 transition-colors">
